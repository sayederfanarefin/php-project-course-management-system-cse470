<?php
  session_start();
    ...
    $submit_status = 0;//0= not submitted 1=wrong secret 2= done  3=insertion failed
     ...
     $row = $result_current_semester->fetch_assoc();
      ...
      if(isset($_POST['submit'])){
          $course_id = $_POST["selected_crs_id"];
          $section = $_POST["crs_sec"];
          $secret = $_POST["secret"];

          $query_get_secret = "SELECT Secret_code FROM teacher_courses WHERE Course_id='".$course_id."' AND Section = '".$section."'";
          $resultu = mysqli_query($conn, $query_get_secret);
          $row33 = $resultu->fetch_assoc();
          $secrett = $row33["Secret_code"];



          if($secrett == $secret){
              $query_insert_student = "INSERT INTO student_courses VALUES (".$student_id.",'".$course_id."','".$section."','".$current_semester."')";
              $resulting = mysqli_query($conn, $query_insert_student);
              if($resulting){
                  $submit_status =2;
              }else{
                  $submit_status =3;
...
<head>
    ...
    <title>Student Settings | BRACU CMS</title>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="col-lg-6">
                        ...
                        <form role="form"  action="student_settings.php" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="selected_crs_id" name="selected_crs_id" required>
                                   <?php 
                                    ...
                                    $query = "SELECT DISTINCT Course_id FROM teacher_courses WHERE semester='".$current_semester."'"; 
                            ...
                            <div class="form-group">
                                <label>Enter Secret Code: Given in class by Faculty</label>
                                <input class="form-control" placeholder="Secret Code" id="secret" name="secret" required>
                            </div>
                            

                            
                             <button type="submit" name="submit" class="btn btn-sm btn-success btn-block">Submit</button>
                            </form>
