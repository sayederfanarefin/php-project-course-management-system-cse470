...
if (isset($_POST['submit'])) {
    $sql = "INSERT INTO complains (User, Complain_text)
    VALUES ('{$teacher_email}', '{$complain}')";
...
<head>
    ...
    <title>Post Complain| BRACU CMS</title>
...
<?php    if($result_messages != NULL){
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i> Post Complain
                            </li>
                        </ol>
                    </div>
                </div>
     ...
     <div class=\"alert alert-success alert-dismissable\">
                                ...
                                Complain successfully received by admin.
                            </div>
     ";
               ...
               <div class="row">
                    <div class="col-lg-12">
                        ...
                        <form role="form" action="complain.php" method="post">

                            <div class="form-group">
                                 <br>
                                <label>Write Complain Here</label>
                                <textarea class="form-control" name="complain" rows="7"></textarea>
                            </div>


                            <button type="submit" name="submit" class="btn btn-warning btn-block">Send Complain</button>
