                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-table"></i> Consultation Booking
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="table-responsive">
                            ...
                            $query = "SELECT * FROM dept_crs,teacher_table,materials where dept_crs.course_Id=materials.course_Id and teacher_table.Email=materials.teacher_email";
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo '
                                    <tr>
                                        ...
                                        <td>'.$fac_intial.'</td>
                                        <td><button type="button"  class="btn btn-lg btn-link">'.$mat.'</button></td>
