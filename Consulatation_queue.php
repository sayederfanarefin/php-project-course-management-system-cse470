<?php
    ...
    if($msg!=""){
    $sql2 = "INSERT INTO messages (User_type_from, User_from, Message, User_to) VALUES ('Teacher','".$teacher_email."','".$msg."',".$student_Id.")";
...
<?php    if($result_messages != NULL){
               ...
               <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="table-responsive">
                            ...
                            $query = "SELECT * FROM consultation_queue where teacher_email='{$teacher_email}' AND decline=0";

                            $result = mysqli_query($conn,$query);
                           
                            $number_row1 = mysqli_num_rows($result);
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo '
                                <form role="form" action="Consulatation_queue.php" method="post">
    ...
    <script>
        ...
        function con_req_den(booking_id, message, teacher_email) {
             complain_reply = document.getElementById(emailorid + "complain_comment").value;
            
             $.ajax({
                 url: "/php-files/con_req_deny.php",
                 type: "POST",
                 data: { 'booking_id': booking_id, 'message': message, 'teacher_email': teacher_email },
