                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-table"></i> Faculty Presence
                            </li>
                        </ol>
                    </div>
                </div>
                        ...
                        <div class="table-responsive">
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo'
                                  ...
                                  if($avail=="1"){
                                  echo'<tr><td><td><td><td><td>Available</td></td></td></td></td></tr>';}
                                  if($avail=="0"){
                                  echo'<tr><td><td><td><td><td>Not Available</td></td></td></td></td></tr>';}    
                                  if($avail=="2"){
                                  echo'<tr><td><td><td><td><td>Busy</td></td></td></td></td></tr>';}
                            }  
                            ...
                            <h2>Faculty Consultation Hour</h2>
                            <table class="table table-hover table-striped">
                                <thead>
                                    <tr>
                                        
                                        <th>Faculty Name</th>
                                        <th>Consultation Start</th>
                                        <th>Consultation End</th>
                            ...
                            <?php
                            include '/php-files/db_connection.php';
                            $query = "SELECT * FROM teacher_table,teacher_consultation_queue where  teacher_table.Email=teacher_consultation_queue.teacher_email";
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                $fac_name = $row["Name"];
                                $cons_start = $row["cons_time_start"];
                                $cons_end = $row["cons_time_end"];
                                $cons_day = $row["cons_day"];
