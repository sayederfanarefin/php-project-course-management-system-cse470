...
<head>
    ...
    <title>Notice | BRACU CMS</title></title>
    ...
    ?>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h2>Find out important Notices!!</h2>
                        <div class="table-responsive">
                            <table class="table table-hover table-striped">
                                ...
                                <tbody>
                                 ...
                                 <?php
                            include '/php-files/db_connection.php';
                            $query = "SELECT * FROM dept_crs,notice where dept_crs.course_Id=notice.course_Id ";
